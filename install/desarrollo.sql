...
INSERT INTO <nombre>bloque (id_bloque, nombre, descripcion, grupo) VALUES (-11,'saraFormCreator', 'Módulo para crear formulario con la recomendación de bloques de OpenSARA.', 'development');
...
INSERT INTO <nombre>bloque (id_bloque, nombre, descripcion, grupo) VALUES (-13,'gestionBloques', 'Módulo para gestionar(CRUD) bloques de desarrollo recomendado en OpenSARA.', 'development');
INSERT INTO <nombre>bloque (id_bloque, nombre, descripcion, grupo) VALUES (-14,'gestionConexiones', 'Módulo para gestionar las conexiones de bases de datos en OpenSARA', 'development');
INSERT INTO <nombre>bloque (id_bloque, nombre, descripcion, grupo) VALUES (-15,'gestionPaginas', 'Módulo para gestionar las páginas en OpenSARA', 'development');
INSERT INTO <nombre>bloque (id_bloque, nombre, descripcion, grupo) VALUES (-16,'navegadorBloques', 'Navegador del directorio de bloques', 'development');
...
INSERT INTO <nombre>bloque_pagina (id_pagina, id_bloque, seccion, posicion) VALUES (-6, -16, 'D', 1 );
